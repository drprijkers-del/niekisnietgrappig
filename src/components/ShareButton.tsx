...
import { getKoningsdagShare, KONINGSDAG_ACCENT } from "@/lib/koningsdag";
...
function getShareUrl(ref: string, siteId: SiteId, groupId?: string) {
  ...
  // Fallback: generate production subdomain URL using shareDomain or domain
...
export default function ShareButton({
  ...
  const handleWhatsApp = () => {
    ...
    const text = kdShare ? kdShare.whatsappText(naam) : site.share.whatsappText(naam);
    window.open(
