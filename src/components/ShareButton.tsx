...
export default function ShareButton({
  ...
  const trackShare = () => {
    ...
    // Get g from URL if not passed as prop
  ...
  return (
    <div className="flex w-full flex-col gap-3">
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-full bg-red-600 px-6 py-3 text-sm font-medium text-white transition-all hover:bg-red-500"
      >
